...
export function DemoAccountCard({ account }: Props) {
  const signal = (account.healthSignal ??
    "inactive") as keyof typeof HEALTH_CONFIG;
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between text-xs text-muted-foreground">
        <span>
          {account.industry ?? account.industryCategory ?? "Sin industria"}
        </span>
        <span>
